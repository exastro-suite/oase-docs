...
| The following section explains the process of installing Exastro OASE on an online environment.
| Make sure to see the  :doc:`../requirements` before installing Exastro OASE.
| For information regarding installing Exastro OASE on an offline environment, please see :doc:`installation_offline`.

Prerequisites
========

* This installation guide requires that the installation server can be connected from the internet.
...
.. tip:: | The operation directory will be used later in this manual.
         | In this manual, the file extraction path (EXTRACT_PATH) is set to :program:`/tmp`. 
...
.. tip::
   ...
   | In this manual's process, the path will be as following.
